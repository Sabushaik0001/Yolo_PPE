...
def _process_ppe_video(video_path: str, output_path: str, frame_skip: int):
    ...
    all_persons = {}
    # Re-iterate tracker state; we collect from tracked_persons that remain + those that were tracked
    # Use next_id as total unique count
    unique_persons = tracker.next_id

    # Collect final PPE status from currently tracked persons
    per_person_ppe = {}
